...
export function IntroMain() {
  ...
  return (
    <section className="flex flex-col items-center bg-[url('/intro-bg.png')] h-[640px] max-w-[1440px] w-fuul m-auto pt-[180px] text-slate-100/95 max-[825px]:h-[540px] max-[570px]:px-[15px] max-[475px]:pt-[100px]">
        ...
        <h3 className='text-[24px] mt-[35px] mb-[20px] max-[825px]:text-[20px] max-[825px]:mt-[25px] max-[825px]:mb-[12px] max-[570px]:text-center max-[475px]:text-[18px]'> We makes every day full of energy and taste </h3>
        <h3 className='text-[24px] max-[825px]:text-[20px] max-[570px]:text-center max-[475px]:text-[18px]'>Want to try our beans?</h3>
