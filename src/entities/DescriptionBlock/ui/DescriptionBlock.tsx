import { propsAboutDescription } from '@/shared/types/types'
...
export function DescriptionBlock({
	...
	return (
		<section
			className={cn(
				'flex flex-col items-center justify-center max-[570px]:order-1 ',
				{
			...
			<div className='mt-[40px] max-[1200px]:mt-[30px]'>
				{aboutProduct === 'no' ? (
					descriptions.map((description, i) => (
						<p
							key={i}
							className='text-center text-[14px] first:mb-[20px] max-[920px]:text-[12px] '
						>
							{description}
							<br />
						</p>
					...
					<div>
						<div className='text-[14px] max-[920px]:text-[12px]'>
							{' '}
							<b className='mr-[10px] '>Country: </b>
							{country}
						</div>{' '}
						<br />
						{descriptions.map((description, i) => (
							<p
								key={i}
								className='text-[14px] first:mb-[20px] max-[920px]:text-[12px]'
							>
						...
						<div className='text-[24px] max-[920px]:text-[20px]'>
							<b className='text-[14px] mr-[10px] max-[920px]:text-[12px]'>
								Price:{' '}
							</b>
							{price}
						</div>
